...
<div class="subform-repeatable-wrapper subform-layout">
    <div class="subform-repeatable"
        ...
        <?php if (!empty($buttons['add'])) { ?>
            <?php if ($jsIcons !== 'none') { ?>
            <a class="uk-button uk-button-small uk-button-primary group-add btn btn-mini button btn-success" data-uk-tooltip="<?php echo Text::_('JGLOBAL_FIELD_ADD'); ?>"><span data-uk-icon="icon:plus" aria-hidden="true"></span></a>
            <?php } else { ?>
            <a class="uk-button uk-button-small uk-button-primary group-add btn btn-mini button btn-success"><?php echo Text::_('JGLOBAL_FIELD_ADD'); ?></a>
            <?php } ?>
        <?php } ?>
    <?php
